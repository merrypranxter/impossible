...
A public pool where the water surface is a black threshold and lane lines bend toward it.
...
A raymarched impossible liminal room called **Event Horizon Municipal Pool**, a public pool where the water surface is a black threshold and lane lines bend toward it. Volumetric fog, soft boolean architecture, SDF distance fields, wrong physics, haunted navigable math, surreal but structured, luminous threshold, phosphor bloom, recursive spatial contradiction.
