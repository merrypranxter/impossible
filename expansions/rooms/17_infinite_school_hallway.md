...
Lockers and tile floors repeat, scale, and misalign while the horizon refuses to stay level.
...
A raymarched impossible liminal room called **Infinite School Hallway of Late Bells**, lockers and tile floors repeat, scale, and misalign while the horizon refuses to stay level. Volumetric fog, soft boolean architecture, SDF distance fields, wrong physics, haunted navigable math, surreal but structured, luminous threshold, phosphor bloom, recursive spatial contradiction.
