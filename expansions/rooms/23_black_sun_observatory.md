...
A raymarched observatory where the telescope looks at a sun-shaped absence that lights the room backwards.
...
A raymarched impossible liminal room called **Black Sun Observatory**, a raymarched observatory where the telescope looks at a sun-shaped absence that lights the room backwards. Volumetric fog, soft boolean architecture, SDF distance fields, wrong physics, haunted navigable math, surreal but structured, luminous threshold, phosphor bloom, recursive spatial contradiction.
