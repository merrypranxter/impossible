...
A grand atrium whose floor drain is a polar-coordinate sigil pulling walls inward.
...
A raymarched impossible liminal room called **Sigil Drain Atrium**, a grand atrium whose floor drain is a polar-coordinate sigil pulling walls inward. Volumetric fog, soft boolean architecture, SDF distance fields, wrong physics, haunted navigable math, surreal but structured, luminous threshold, phosphor bloom, recursive spatial contradiction.
