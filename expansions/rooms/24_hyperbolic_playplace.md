...
Plastic tubes and ball pits arranged with hyperbolic scale; every crawl tunnel contains more room than the outside.
...
A raymarched impossible liminal room called **Hyperbolic Fast-Food Playplace**, plastic tubes and ball pits arranged with hyperbolic scale; every crawl tunnel contains more room than the outside. Volumetric fog, soft boolean architecture, SDF distance fields, wrong physics, haunted navigable math, surreal but structured, luminous threshold, phosphor bloom, recursive spatial contradiction.
